...
class GetLastExerciseSetsByMovementBloc extends Bloc<
    GetLastExerciseSetsByMovementEvent,
  ...
  Stream<GetLastExerciseSetsByMovementState> _mapLoadMovementIdToState(QueryLastExerciseSetsByMovementEvent event) async* {
    yield GetLastExerciseSetQueryingState();
    try {
      List<Map> results = await exerciseSetRepository.getLatestExerciseSetsByMovement(event.movementId);
      yield SuccessfulGetLastExerciseSetsByMovementQueryState(lastExerciseSets: results);
    } catch (e) {
